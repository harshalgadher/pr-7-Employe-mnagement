            ...
            <div class="-my-6 divide-y divide-gray-200">
              <div class="space-y-4 py-6 md:py-8">
                <div class="grid gap-4">
                  ...
                  <a href="#" class="text-xl font-semibold text-gray-900 hover:underline hover:text-emerald-500 transition-all duration-200">“The specs say this model has 2 USB ports. The one I received has none. Are they hidden somewhere?”</a>
                </div>
              ...
              <div class="space-y-4 py-6 md:py-8">
                <div class="grid gap-4">
                  ...
                  <a href="#" class="text-xl font-semibold text-gray-900 hover:underline hover:text-emerald-500 transition-all duration-200">“For an inexpert 85-year-old general user with a ten-year old iMac (OSX Yosemite version 10.10.5), is this latest model 24" iMac with Retina 4.5K display Apple M1 8GB memory - 256GB SSD a decent upgrade?”</a>
                </div>
              ...
              <div class="space-y-4 py-6 md:py-8">
                <div class="grid gap-4">
                  ...
                  <a href="#" class="text-xl font-semibold text-gray-900 hover:underline hover:text-emerald-500 transition-all duration-200">“Is this just the monitor?”</a>
                </div>
