  ...
  return (
    <section class="bg-white ">
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16   border-bottom-2 border-black">
          <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-emerald-500 ">Designed for business <br /> teams like yours</h2>
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div className="">
            ...
            <h3 class="mb-2 text-xl font-bold text-emerald-500 ">Marketing</h3>
          ...
          <div className="">
            ...
            <h3 class="mb-2 text-xl font-bold text-emerald-500 ">Legal</h3>
          ...
          <div className="">
            ...
            <h3 class="mb-2 text-xl font-bold text-emerald-500 ">Business Automation</h3>
          ...
          <div className="">
            ...
            <h3 class="mb-2 text-xl font-bold text-emerald-500 ">Finance</h3>
          ...
          <div className="">
            ...
            <h3 class="mb-2 text-xl font-bold text-emerald-500 ">Enterprise Design</h3>
          ...
          <div className="">
            ...
            <h3 class="mb-2 text-xl font-bold text-emerald-500 ">Operations</h3>
